    ...
    public function success(Request $request)
    {
        ...
        if(isset($request->value_c)){
            ...
            elseif ($request->value_c == 'customer_package_payment') {
                ...
                return $customer_package_controller->purchase_payment_done($request->value_b, $payment);
            }
            elseif ($request->value_c == 'seller_package_payment') {
                $seller_package_controller = new SellerPackageController;
                return $seller_package_controller->purchase_payment_done($request->value_b, $payment);
            }
        }
    }
