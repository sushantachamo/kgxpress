                            ...
                            <div class="row">
                                ...
                                @if (!empty($banners[0]))
                                    <div class="col-lg-3 d-none d-lg-block">
                                        <div class="media-banner mb-3 mb-lg-0">
                                            <a href="{{ $banners[0]->url }}" target="_blank" class="banner-container">
                                                <img src="{{ asset('frontend/images/placeholder-rect.jpg') }}" data-src="{{ asset($banners[0]->photo) }}" alt="{{ env('APP_NAME') }} promo" class="img-fluid lazyload">
                                            </a>
                                        </div>
                                    </div>
                                @endif
                                <div class="col-lg-3 d-none d-lg-block">
                                    @if (!empty($banners[1]))
                                        <div class="col-lg-3 d-none d-lg-block">
                                            <div class="media-banner mb-3 mb-lg-0">
                                                <a href="{{ $banners[1]->url }}" target="_blank" class="banner-container">
                                                    <img src="{{ asset('frontend/images/placeholder-rect.jpg') }}" data-src="{{ asset($banners[1]->photo) }}" alt="{{ env('APP_NAME') }} promo" class="img-fluid lazyload">
                                                </a>
                                            </div>
                                        </div>
                                    @endif
    ...
    <div class="mb-4">
        <div class="container">
            <div class="row gutters-10">
                @php
                    $banners2 = \App\Banner::where('position', 1)->where('published', 1)->skip(2)->take(3)->get();
                @endphp
                @foreach ($banners2 as $key => $banner)
                    <div class="col-lg-{{ 12/count($banners2) }}">
                        <div class="media-banner mb-3 mb-lg-0">
