<div class="header bg-white">
    ...
    <div class="position-relative logo-bar-area">
              ...
              <div class="row no-gutters align-items-center">
                  <div class="col-lg-3 col-8">
                      <div class="d-flex">
                        ...
                        <!-- <div class="locale-select top-navbar mx-auto d-inline-block" style="background: none; border: none;">
                              <ul class="inline-links d-lg-inline-block d-flex justify-content-between">
                                  <li class="dropdown" id="lang-change">
                                      ...
                                      <a href="" class="dropdown-toggle top-bar-item" data-toggle="dropdown">
                                          <img src="{{ my_asset('frontend/images/placeholder.jpg') }}" height="11" data-src="{{ my_asset('frontend/images/icons/flags/'.$locale.'.png') }}" class="flag lazyload" alt="{{ \App\Language::where('code', $locale)->first()->name }}" height="11"><span class="language">Location</span>
                                      </a>
      ...
      <div style="padding-top: 8px; border-top: 1px solid #f1f1f1;">
         <div class="row">
            <div class="col-lg-12">
              <div class="category-sidebar" style="width: calc(100% - 18px);">
              <div class="categories slick-carousel caorusel-box" data-slick-items="9" style="padding: 0 32px;">
                <div class="d-lg-none">
                  <a href="{{ route('categories.all') }}" class="text-truncate">
                    <img class="cat-image lazyload" src="{{ asset('frontend/images/placeholder.jpg') }}" data-src="{{ asset('frontend/images/icons/list.png') }}" width="30" alt="{{ translate('All Category') }}">
                ...
                @foreach (\App\Category::all()->take(11) as $key => $category)
                  ...
                  <div class="category-nav-element" data-id="{{ $category->id }}" style="flex: 1 0 auto;">
                    <a href="{{ route('products.category', $category->slug) }}" class="text-truncate d-flex justify-content-center align-items-center flex-column">
                      <img class="cat-image lazyload" src="{{ asset('frontend/images/placeholder.jpg') }}" data-src="{{ asset($category->icon) }}" width="30" alt="{{ __($category->name) }}" height="30
