...
Route::group(['middleware' => ['checkout']], function(){
	...
	// Check NIBL payment
	Route::get('/nibl_payment', 'CheckoutController@nibl_payment')->name('checkout.nibl.payment');
	Route::post('/nibl_payment/process', 'CheckoutController@nibl_payment_process')->name('checkout.nibl.payment.process');
	Route::post('/nibl-payment/confirm', 'CheckoutController@nibl_payment_confirm')->name('checkout.nibl.payment.confirm');
	Route::get('/nibl/payment-fail', 'CheckoutController@nibl_payment_fail')->name('checkout.nibl.payment.fail');
	Route::get('/nibl/payment-success', 'CheckoutController@nibl_payment_success')->name('checkout.nibl.payment.success');

	// ConnectIps Payment
	Route::get('/connectips/confirm', 'CheckoutController@connect_ips_confirm')->name('checkout.connectips.confirm');
	Route::get('/connectIPS', 'CheckoutController@connect_ips_payment')->name('checkout.connectips.payment');
	//for success payment
	Route::get('/checkout/payment-success', 'CheckoutController@connect_ips_payment_success_fail');
	//for fail payment
	Route::get('/checkout/payment-fail', 'CheckoutController@connect_ips_payment_success_fail');
