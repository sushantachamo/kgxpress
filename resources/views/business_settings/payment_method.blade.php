...
<div class="row">
    ...
    <!--    <div class="panel">-->
    <!--        <div class="panel-heading">-->
    <!--            <h3 class="panel-title text-center">{{translate('Connect Ips Activation')}}</h3>-->
    <!--        </div>-->
    <!--        <div class="panel-body">-->
    <!--            <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">-->
    <!--                @csrf-->
    <!--                <input type="hidden" name="payment_method" value="connectips_payment">-->
    <!--                <div class="form-group">-->
    <!--                    <div class="col-lg-3">-->
    <!--                        <label class="control-label">{{translate('ConnectIps Mode')}}</label>-->
    <!--                    </div>-->
    <!--                    <div class="col-lg-6">-->
    <!--                        <label class="switch">-->
    <!--                            <input value="1" name="connectips_payment" type="checkbox" @if (\App\BusinessSetting::where('type', 'connectips_payment')->first()->value == 1)-->
    <!--                                checked-->
    <!--                            @endif>-->
    <!--                            <span class="slider round"></span>-->
    <!--                        </label>-->
    ...
    <!--            <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">-->
    <!--                @csrf-->
    <!--                <input type="hidden" name="payment_method" value="nibl_payment">-->
    <!--                <div class="form-group">-->
    <!--                    <div class="col-lg-3">-->
    <!--                        <label class="control-label">{{translate('NIBL Bank Mode')}}</label>-->
    <!--                    </div>-->
    <!--                    <div class="col-lg-6">-->
    <!--                        <label class="switch">-->
    <!--                            <input value="1" name="nibl_payment" type="checkbox" @if (\App\BusinessSetting::where('type', 'nibl_payment')->first()->value == 1)-->
    <!--                                checked-->
    <!--                            @endif>-->
    <!--                            <span class="slider round"></span>-->
    <!--                        </label>-->
