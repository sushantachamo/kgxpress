                                                ...
                                                @if(\App\BusinessSetting::where('type', 'payhere')->first()->value == 1)
                                                   <div class="col-6">
                                                       <label class="payment_option mb-4" data-toggle="tooltip" data-title="payhere">
                                                           ...
                                                           <span>
                                                               <img loading="lazy"  src="{{ asset('frontend/images/icons/cards/payhere.png')}}" class="img-fluid">
                                                           </span>
                                                       </label>
                                                   </div>
                                               @endif
                                                ...
                                                @endif
                                                {{-- ConnectIps payment --}}
                                                @if(\App\BusinessSetting::where('type', 'connectips_payment')->first()->value == 1)
                                                    @php
                                                        $digital = 0;
                                                    ...
                                                    @if($digital != 1)
                                                        <div class="col-6">
                                                            <label class="payment_option mb-4" data-toggle="tooltip" data-title="ConnectIps Payment">
                                                                <input type="radio" id="" name="payment_option" value="bank_payment" class="online_payment">
                                                                <span>
                                                                    <a href="{{route('checkout.connectips.confirm')}}">
                                                ...
                                                @endif
                                                {{-- NIBL payment --}}
                                                @if(\App\BusinessSetting::where('type', 'nibl_payment')->first()->value == 1)
                                                    @php
                                                        $digital = 0;
                                                        foreach(Session::get('cart') as $cartItem){
                                                            if($cartItem['digital'] == 1){
                                                    ...
                                                    @if($digital != 1)
                                                        <div class="col-6">
                                                            <label class="payment_option mb-4" data-toggle="tooltip" data-title="NIBL Payment">
                                                                <input type="radio" id="" name="payment_option" value="bank_payment" class="online_payment">
                                                                <span>
                                                                    <a href="{{route('checkout.nibl.payment')}}">
                                                                        <img loading="lazy"  src="{{ asset('frontend/images/icons/cards/NIBL.jpg')}}" class="img-fluid" style="height:84px;width:156px">
                                                                    </a>
                                                                </span>
                                                            </label>
                                                        </div>
