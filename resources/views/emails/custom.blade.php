...
application/x-httpd-php newsletter.blade.php ( PHP script text )
<?php 
    $greetings = null;
    $time =date("H");
    $timezone = date("e");
                                        ...
                                        <table>
                                            <tr>
                                                <td valign="top" style="text-align: center; padding: 60px 0 10px 20px;">
                                                    <h1 style="margin: 0; font-family: 'Montserrat', sans-serif; font-size: 30px; line-height: 36px; color: #ffffff; font-weight: bold;">WELCOME <span style="font-size:1rem"></span>,</h1>
                                                </td>
                                            </tr>
                                            <tr>
