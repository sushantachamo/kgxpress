    ...
    <div class="panel-body">
        <div class="">
            ...
            <div class="text-center">
                <div class="pad-ver">
                    <img src="{{ my_asset($seller->user->avatar_original) }}" class="img-lg img-circle" alt="Profile Picture">
                </div>
            ...
            <!-- Profile Details -->
            <p class="pad-ver text-main text-sm text-uppercase text-bold">{{translate('About')}} {{ $seller->user->name }}</p>
            ...
            <p class="pad-ver text-main text-sm text-uppercase text-bold">{{translate('Payout Info')}}</p>
